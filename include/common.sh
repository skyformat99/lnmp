...
mysql_version[2]="mysql-5.6.36-linux-glibc2.5-${db_bit}"
mysql_version[4]="mysql-5.7.18"
mysql_gz[1]="${mysql_version[1]}.tar.gz"
mysql_gz[2]="${mysql_version[1]}-linux-glibc2.5-${db_bit}.tar.gz"
mysql_gz[3]="${mysql_version[4]}-linux-glibc2.5-${db_bit}.tar.gz"
mysql_gz[4]="mysql-boost-5.7.18.tar.gz"
mysql_dir[2]="${mysql_version[1]}-linux-glibc2.5-${db_bit}"
mysql_dir[3]="${mysql_version[4]}-linux-glibc2.5-${db_bit}"
